...
const standardNotes = [
  ...
  ["前台介绍", "搭配产品小卡片，帮助服务员快速讲清产区、原料和青绿色来源。"],
];
    ...
    <main className="min-h-screen overflow-hidden bg-[#f7f3e9] text-[#10251d]">
      ...
      <section className="mx-auto max-w-5xl px-5 py-24 text-center sm:px-8 sm:py-32">
        ...
        <p className="mx-auto mt-8 max-w-3xl text-lg leading-9 text-[#5f7067]">
          酸梅汤、玉米汁、柠檬茶、奶茶和咖啡已经成为常规选择。酒店、餐饮和文旅空间需要的不只是一杯饮品，而是一种能被记住的体验：有地方风味，有视觉辨识度，也能稳定落地。
        </p>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 sm:px-8 sm:py-32">
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          ...
          <div className="space-y-6 text-lg leading-9 text-[#5f7067]">
            <p>
              第一眼的青绿色，是紫苏油茶天然的视觉符号。它来自紫苏、茶底与绿色辛香植物共同呈现的自然色泽，不依靠夸张调色，也不需要复杂装饰。
            </p>
            <p>
              清晰的颜色辨识度，让这杯饮品更适合出现在菜单图、欢迎饮小杯和产品介绍卡中。真实食材、清爽口感与广西特色，可以被更直观地传达给顾客。
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-[#607067]">
                一款新品能否长期留在菜单上，取决于稳定出品：颜色稳定、口感稳定、员工容易掌握。清晰的出品标准，帮助门店更顺畅地完成试饮、上架与复购。
              </p>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 sm:px-8 sm:py-32">
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="space-y-7 text-lg leading-9 text-[#5f7067]">
            <p>
              入口之物，首先要经得起日常饮用的检验。紫苏、姜、茶和辛香植物原料都经过认真筛选，让传统风味不只停留在概念与外观。
            </p>
            <p>
              创始人高兴来自桂林，从小熟悉油茶的日常味道。产品选用云南小黄姜、自家种植的双面紫苏，并持续优化嫩叶采摘、研磨细度和出品稳定性，让传统油茶更干净、更稳定，也更适合现代餐饮场景。
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#fbf8ef]">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-24 sm:px-8 sm:py-32 lg:grid-cols-[0.85fr_1.15fr]">
          <div>
            ...
            <h2 className="mt-5 text-4xl font-semibold leading-tight sm:text-5xl">让门店更容易介绍一杯新饮品</h2>
          </div>
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ["产品小卡片", "呈现产区、原料、轻油感和青绿色来源，让顾客一眼理解。"],
              ["前台介绍建议", "用简短表达讲清“这是什么、怎么喝、适合什么场景”。"],
              ["扫码申请入口", "名片、菜单和桌牌均可接入网页，方便客户申请样品。"],
            ].map(([title, text]) => (
