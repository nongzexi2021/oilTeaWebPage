      ...
      <section className="mx-auto max-w-7xl px-5 py-24 sm:px-8 sm:py-32">
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          ...
          <div className="space-y-6 text-lg leading-9 text-[#5f7067]">
            <p>
              紫苏油茶的青绿色，往往是顾客第一次注意到它的原因。它来自紫苏、茶底与绿色辛香植物共同呈现的自然色泽，不依靠夸张调色，也不需要复杂装饰。
            </p>
            <p>
              对门店来说，这是一种容易被看见、也容易被解释的产品记忆点。配合菜单图、欢迎饮小杯和产品介绍卡，可以把“真实食材、清爽口感、广西特色”讲得更清楚。
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-[#607067]">
                新品能不能长期卖，关键在于稳定：颜色稳定、口感稳定、员工容易学会。我们把出品动作拆成清晰的标准建议，让门店更轻松地完成试饮、上架和复购。
              </p>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 sm:px-8 sm:py-32">
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="space-y-7 text-lg leading-9 text-[#5f7067]">
            <p>
              做入口的东西，首先要经得起自己和家人的日常饮用。紫苏、姜、茶和辛香植物原料都需要认真筛选，不能只做一个好看的概念。
            </p>
            <p>
